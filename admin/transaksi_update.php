...
if($filename == ""){
	mysqli_query($koneksi, "update transaksi set transaksi_tanggal='$tanggal', transaksi_jenis='$jenis', transaksi_kategori='$kategori', transaksi_nominal='$nominal', transaksi_keterangan='$keterangan', transaksi_bank='$bank', status='$status', keterangan_status='$ket_status' where transaksi_id='$id'") or die(mysqli_error($koneksi));
	...
	if(!in_array($ext,$allowed) ) {
		...
		mysqli_query($koneksi, "update transaksi set transaksi_tanggal='$tanggal', transaksi_jenis='$jenis', transaksi_kategori='$kategori', transaksi_nominal='$nominal', transaksi_keterangan='$keterangan',transaksi_foto='$xgambar', transaksi_bank='$bank'status='$status', keterangan_status='$ket_status' where transaksi_id='$id'");
		header("location:transaksi.php?alert=berhasilupdate");
	}
}
