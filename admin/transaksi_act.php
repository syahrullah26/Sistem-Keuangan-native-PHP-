...
if($filename == ""){
	mysqli_query($koneksi, "insert into transaksi values (NULL,'$tanggal','$jenis','$kategori','$nominal','$keterangan','','$bank','$status','$ket_status')")or die(mysqli_error($koneksi));
	...
	if(!in_array($ext,$allowed) ) {
		...
		mysqli_query($koneksi, "insert into transaksi values (NULL,'$tanggal','$jenis','$kategori','$nominal','$keterangan','$file_gambar','$bank','$status','$ket_status')");
		header("location:transaksi.php?alert=berhasil");
	}
}
