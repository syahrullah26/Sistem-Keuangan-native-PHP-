              ...
              <table class="table table-bordered table-striped" id="table-datatable">
                <thead>
                  <tr>
                    ...
                    <th colspan="2" class="text-center" width="10%" >STATUS</th>
                ...
                <tbody>
                  ...
                  while($d = mysqli_fetch_array($data)){
                    $status=$d['status'];
                    $ket_status=$d['keterangan_status'];
                    ?>
                    <tr>
                              ...
                              <div class="modal-content">
                                ...
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    ...
                                    <input type="hidden" name="ket_status" value="<?php echo $d['keterangan_status'] ?>">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <p>Yakin ingin menghapus data <?php echo $d['transaksi_id'] ?> ? </p>

                              </div>
                          <div class="form-group" <?php echo $d['transaksi_id'] ?>>
                          </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
