            ...
            <div class="table-responsive">
              <table class="table table-bordered table-striped" id="table-datatable">
                ...
                <tbody>
                  ...
                  include '../koneksi.php';
                  $no=1;
                  $data = mysqli_query($koneksi,"SELECT * FROM transaksi,kategori where kategori_id=transaksi_kategori AND status!='tertunda' order by transaksi_id desc");
                    ...
                    <tr>
                      ...
                      <td>    
                        ...
                        <?php if($status=='terima'){?>
                          <button type="button"   class="btn btn-danger btn-sm" data-toggle="modal" data-target="#tolak_transaksi_<?php echo $d['transaksi_id'] ?>">
                          <i class="fa fa-warning"></i>
                        </button>
                        <?php
                        }if($status=='tolak'){?>
                        <button type="button" disabled  class="btn btn-danger btn-sm" data-toggle="modal" data-target="#tolak_transaksi_<?php echo $d['transaksi_id'] ?>">
                          <i class="fa fa-warning"></i>
                        </button>
                        <?php}{?>
                        <?php }?>
                      <!--   <button type="button" class="btn btn-primary btn-danger" data-toggle="modal" data-target="#hapus_transaksi_<?php echo $d['transaksi_id'] ?>">
