                  ...
                  while($d = mysqli_fetch_array($data)){
                    ...
                    <tr>
                      ...
                      <td>    
                        ...
                        if ($status=="tertunda"){
                          ?>
                           <button type="button"   class="btn btn-primary btn-sm" data-toggle="modal" data-target="#terima_transaksi_<?php echo $d['transaksi_id'] ?>">
                          <i class="fa fa-check"></i>
                        </button>

                        <button type="button"  class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tolak_transaksi_<?php echo $d['transaksi_id']?>">
                        ...
                        if ($status=="terima"){
                          ?>
                        <button type="button"  disabled class="btn btn-primary btn-sm" data-toggle="modal" data-target="#terima_transaksi_<?php echo $d['transaksi_id'] ?>">
                          <i class="fa fa-check"></i>
                        </button>
                        ...
                        <button type="button" disabled  class="btn btn-primary btn-sm" data-toggle="modal" data-target="#tolak_transaksi_<?php echo $d['transaksi_id'] ?>">
                          <i class="fa fa-warning"></i>
                        </button>
                        <?php}
                        {?>
                        ...
                        <form action="transaksi_update.php" method="post" enctype="multipart/form-data">
                          <div class="modal fade" id="edit_transaksi_<?php echo $d['transaksi_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                              <div class="modal-content">
                                <div class="modal-header">
                                  <h4 class="modal-title" id="exampleModalLabel">Transaksi</h4>
                                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                  </button>
                                </div>
                                <div class="modal-body">
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    ...
                                    <input type="text" style="width:100%" name="tanggal" required="required" class="form-control datepicker2" value="<?php echo $d['transaksi_tanggal'] ?>"readonly>
                                  </div>
                                  ...
                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    <label>Nominal</label>
                                    <input type="number" style="width:100%" name="nominal" required="required" class="form-control" placeholder="Masukkan Nominal .." value="<?php echo $d['transaksi_nominal'] ?>"readonly>
                                  </div>

                                  <div class="form-group" style="width:100%;margin-bottom:20px">
                                    <label>Keterangan</label>
                                    <textarea name="keterangan" style="width:100%" class="form-control" rows="4"readonly><?php echo $d['transaksi_keterangan'] ?></textarea>
                                  </div>
                        ...
                        <!-- modal tertunda -->
                        <!-- <div class="modal fade" id="tunda_transaksi_<?php echo $d['transaksi_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLabel">Peringatan!</h4>
                              ...
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                <a href="transaksi_status.php?id=<?php echo $d['transaksi_id'] ?>&status=tertunda" class="btn btn-primary">Hapus</a>
                              </div>
                            </div>
                          </div>
                        </div> -->
                        ...
                        <!-- modal terima -->
                        <div class="modal fade" id="terima_transaksi_<?php echo $d['transaksi_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLabel">Peringatan!</h4>
                              ...
                              <div class="modal-body">
                                ...
                                <p>Yakin ingin menerima transaksi ini ?</p>

                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                <a href="transaksi_status.php?id=<?php echo $d['transaksi_id'] ?>&status=terima" class="btn btn-primary">Terima</a>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <!-- modal tolak -->
                        <div class="modal fade" id="tolak_transaksi_<?php echo $d['transaksi_id'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                                <h4 class="modal-title" id="exampleModalLabel">Peringatan!</h4>
                              ...
                              <div class="modal-body">
                                ...
                                <p>Yakin ingin menolak transaksi ini ?</p>

                              </div>
                              <div class="modal-footer">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                <a href="transaksi_status.php?id=<?php echo $d['transaksi_id'] ?>&status=tolak" class="btn btn-primary">Tolak</a>
                              </div>
                            </div>
                          </div>
                        </div>
